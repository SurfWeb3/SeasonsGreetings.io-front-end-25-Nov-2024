...
import { THANKSGIVING_NFTS } from "@/common/nfts";
import Link from "next/link";

export default function ThanksgivingPage() {
    return (
        <Container className="my-16 flex-col">
            <h1 className="text-3xl font-bold text-center mb-8 text-white">Thanksgiving NFTs</h1>
            <div className="flex flex-wrap justify-center gap-4">
                {THANKSGIVING_NFTS.map((nft, index) => (
