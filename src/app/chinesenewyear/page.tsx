...
import { CHINESE_NEWYEAR_NFTS } from "@/common/nfts";
import Link from "next/link";

export default function ChineseNewYearPage() {
    return (
        <Container className="my-16 flex-col">
            <h1 className="text-3xl font-bold text-center mb-8 text-white">Chinese New Year NFTs</h1>
            <div className="flex flex-wrap justify-center gap-4">
                {CHINESE_NEWYEAR_NFTS.map((nft, index) => (
